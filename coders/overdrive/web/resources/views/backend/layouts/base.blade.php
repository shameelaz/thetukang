...
<html lang="en" class="light">
    ...
    <body class="main" style="background-color: #4864BA">
                @include('web::backend.layouts.menum_mobile')
        <div class="flex">
            <!-- BEGIN: Side Menu -->
                @include('web::backend.layouts.menum')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
              ...
              document.getElementById('notis').innerHTML = "{{$counts}}";
    ...
    <script type="text/javascript">
          ...
          function reveal()
          {
              if(document.getElementById('skey').style.display === "block")
              {
