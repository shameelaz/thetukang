...
<div class="bg-light py-4">
    <div class="container">
        <h5 class="header-style m-0">UPDATE PROFILE</h5>
    </div>
</div>
    ...
    <div class="card style-border">
        <div class="card-body p-md-4">
            ...
            @if(data_get($user,'profile.user_level') == 2)
                ...
                {!! form()->open()->post()->action(url('/update/profile'))->attribute('id', 'myform')->horizontal() !!}
                <input type="hidden" name="userid" value="{{data_get($user,'id')}}">
                <div id="div-individu" style="">
                    ...
                    <div class="row mb-3">
                        <label for="" class="col-sm-2 col-form-label">Type of Identification</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" id="status" name="status">
                                <option value="1" <?php if(data_get($user,'status')==1){echo "selected" ;}?>> Active</option>
                                <option value="0" <?php if(data_get($user,'status')==0){echo "selected" ;}?>> Not Active</option>
                            </select>
                        </div>
                    </div>
