...
namespace Portal\Timesheet\Http\Notifications\Mailable;
...
use Portal\Ecuti\Http\Notifications\TimesheetMailer;
...
class TestEmail extends Mailable
{
    ...
    {
        return $this->from('portaladmin@Timesheet.gov.my')
