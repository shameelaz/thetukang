...
(function (window, document, $) {
  ...
  var UserStatisticsBarChart = new Chartist.Bar(
    "#user-statistics-bar-chart",
    {
      ...
      series: [
        [4000, 8000, 12000, 14000, 12000, 18000, 4000, 8000, 12000, 14000, 12000, 18000],
        [5000, 10000, 13000, 12000, 11000, 15000, 4000, 8000, 12000, 14000, 12000, 18000]
      ]
    },
    {
