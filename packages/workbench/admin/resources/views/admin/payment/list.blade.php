...
<div class="bg-light py-4">
  <div class="container">
      <h5 class="header-style">Pengurusan Payment Gateaway</h5>
  </div>
</div>
<div class="container">
        ...
        <div class="card-header">
            ...
            <div class="gap-2">
                <div style="float: left">
                    <h6 class="mt-2 float-left">Senarai Payment Gateaway</h6>
                </div>
                            ...
                            <table id="data-table-agency" class="table mt-2" style="width:100%;font-size: 12px;">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th style="text-align: left;">Nama Payment Gateaway</th>
                                        ...
                                        @foreach($payment as $key =>$value)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="/admin/payment/edit/{{$value->id}}" class="btn btn-primary mr-1 mb-2" title="Kemaskini">
