...
<div class="bg-light py-4">
  <div class="container">
      <h5 class="header-style">Tambah Kajian Kepuasan Pelanggan</h5>
  </div>
</div>
<div class="container my-5">
    ...
    <div class="card rounded style-border">
        ...
        {!! form()->open()->post()->action(url('/admin/survey/save'))->attribute('id', 'myform')->multipart()->horizontal() !!}
        ...
        <div id="div" style="">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" id="description" name="description" type="text" required>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" id="rate" name="rate" type="number" required>
                </div>
