...
<div class="bg-light py-4">
  <div class="container">
      <h5 class="header-style">Kemaskini Banner</h5>
  </div>
</div>
<div class="container my-5">
    ...
    <div class="card rounded style-border">
        ...
        {!! form()->open()->post()->action(url('/admin/banner/update'))->attribute('id', 'myform')->multipart()->horizontal() !!}
        <input type="hidden" name="id" value="{{ data_get($banner,'id') }}" />
        <div id="div" style="">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <figure class="figure">
                        ...
                        <img src="{{data_get($banner,'image')}}" class="img-thumbnail figure-img img-fluid rounded " alt="..." style="width:500px; height:200px;">
                        @else
                    ...
                    @if(data_get($banner,'image'))
                        <input class="form-control form-control-sm" placeholder="Banner" id="banner" name="banner" type="file" >
                    @else
            ...
            {{-- <div class="row mb-3">
                <label for="" class="col-sm-2 col-form-label">Tukar Banner</label>
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" placeholder="Banner" id="banner" name="banner" type="file" >
                </div>
            </div> --}}
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" placeholder="Tajuk" id="tajuk" name="tajuk" type="text" value="{{ data_get($banner,'tajuk') }}" required>
                </div>
            </div>
            <div class="row mb-3">
                <label for="message" class="col-sm-2 col-form-label">Penerangan</label>
                <div class="col-sm-10">
                    <textarea placeholder="Penerangan" class="ckeditor form-control " id="message" name="message" rows="5" required="">{{ data_get($banner,'penerangan') }}</textarea>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control datepicker1" id="date_start" name="date_start"
                        value="{{ date('d-m-Y',strtotime(data_get($banner,'tarikh_mula'))) }}" required >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control datepicker2" id="date_end" name="date_end"
                        value="{{ date('d-m-Y',strtotime(data_get($banner,'tarikh_tamat')))  }}" required >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" id="url" name="url" type="text" value="{{ data_get($banner,'url') }}" required>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" id="order" name="order" type="number" value="{{ data_get($banner,'order') }}" required>
                </div>
            ...
            <div class="row mb-3" id="div-status">
                ...
                <div class="col-sm-10">
                    ...
                    <select class="form-select" id="status" name="status" required="required">
                        ...
                        <option value="1" <?php if(data_get($banner,'status')==1){echo "selected" ;}?>> Aktif </option>
                        <option value="0" <?php if(data_get($banner,'status')==0){echo "selected" ;}?>> Tidak Aktif </option>
                    </select>
