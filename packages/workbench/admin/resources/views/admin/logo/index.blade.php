...
<div class="bg-light py-4">
  <div class="container">
      <h5 class="header-style">Pengurusan Logo</h5>
  </div>
</div>
<div class="container my-5">
    ...
    <div class="card rounded style-border">
        ...
        <div class="alert alert-warning" role="alert">
            ...
            <p class="mb-0">
                <ul>
                    <li>Sila pastikan hanya format png</li>
        ...
        {!! form()->open()->post()->action(url('/base/logo/update'))->attribute('id', 'myform')->multipart()->horizontal() !!}
        ...
        <div id="div" style="">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <figure class="figure">
                        @if( data_get($logo,'logo_negeri'))
                        <img src="{{data_get($logo,'logo_negeri')}}" class="img-thumbnail figure-img img-fluid rounded logo" alt="..." style="height:60px">
                        @else
                        <img src="{{ asset('overide/web/themes/perakepay/assets/images/logo/logo-handyman.png') }}" class="logo figure-img img-fluid rounded" />
                        @endif

                        <figcaption class="figure-caption">Logo Negeri</figcaption>
                    </figure>
            ...
            <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Logo Negeri</label>
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" id="logo_negeri" name="logo_negeri" type="file">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label"></label>
                <div class="col-sm-10">
                    ...
                    <figure class="figure">
                        @if( data_get($logo,'logo_sistem'))
                        <img src="{{data_get($logo,'logo_sistem')}}" class="img-thumbnail figure-img img-fluid rounded logo" alt="..." style="height:60px">
                        @else
            ...
            <div class="row mb-3">
                <label for="email" class="col-sm-2 col-form-label">Logo Sistem</label>
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" id="logo_sistem" name="logo_sistem" type="file">
                </div>
