        ...
        <div class="card-header">
            ...
            <div class="gap-2">
                <div style="float: left">
                            <h6 class=" mt-2 float-left">Senarai Pengguna Agensi / PTJ</h6>
                </div>
                <div style="float: right">
                            <a href="/admin/user/agency/add" class="btn btn-primary me-md-2">Tambah</a>
                </div>
            </div>
                                    ...
                                    <?php $bil=1;?>
                                        @foreach($user as $key =>$value)
                                            <tr>
                                                ...
                                                <td>
                                                    {{data_get($value,'role.0.name.name')}}
                                                </td>
                                                <td>{{ data_get($value,'profile.userAgency.name') }}</td>
                                                ...
                                                <td>
                                                    <a href="/admin/user/agency/edit/{{$value->id}}" class="btn btn-primary mr-1 mb-2" alt="Kemaskini" title="Kemaskini">
      ...
      <div class="modal-body">
        {!! form()->open()->post()->action(url('/admin/user/awam/password'))->horizontal()->attribute('id', 'myform') !!}
             ...
             <div class="px-5 pb-8 text-center">
                ...
                <button type="button" data-bs-dismiss="modal" class="btn btn-primary w-24 dark:border-dark-5 dark:text-gray-300 mr-1">Batal</button>
