...
<div class="bg-light py-4">
    <div class="container">
        <h5 class="header-style m-0">Kemaskini Pengguna Dalaman</h5>
    </div>
</div>
...
<div class="container my-5">
    ...
    <div class="card style-border">
        ...
        {!! form()->open()->post()->action(url('/admin/user/internal/update'))->attribute('id', 'myform')->horizontal() !!}
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name"
                        ...
                        oninput="setCustomValidity('')" value="{{ data_get($user,'name')}}" required>
                </div>
            </div>
