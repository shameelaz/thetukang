...
<div class="bg-light py-4">
    <div class="container">
        <h5 class="header-style m-0">Tambah Pengurusan Perkhidmatan</h5>
    </div>
</div>
...
<div class="container my-5">
    ...
    <div class="card style-border">
        ...
        {!! form()->open()->post()->action(url('/admin/khidmat/save'))->attribute('id', 'myform')->horizontal() !!}
            ...
            <div class="row mb-3" id="div-type">
                ...
                <div class="col-sm-10">
                    ...
                    <select class="form-select" id="type" name="type" required="required">
                            ...
                            <option value="3"> Pelbagai Kod Hasil </option>
                    </select>
            ...
            <div class="row mb-3" id="div-type-rate">
                ...
                <div class="col-sm-10">
                    ...
                    <select class="form-select" id="type_rate" name="type_rate" required="required">
                            ...
                            <option value="3"> Kadar Bayaran : Sebut Harga / Tender </option>
                    </select>
