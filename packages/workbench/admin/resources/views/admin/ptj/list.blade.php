...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card style-border">
            <div class="card-header">
                ...
                <div class="gap-2">
                    <div style="float: left">
                        <h6 class="mt-2 float-left">Senarai PTJ : {{ strtoupper(data_get($agency, 'name')) }}</h6>
                    </div>
                    <div style="float: right">

                        <a href="/admin/agency/ptj/add"
            ...
            {{-- @if ($roleid == '2' )
            {!! form()->open()->post()->action(url('/admin/agency/ptj/listresult'))->attribute('id', 'myform')->horizontal() !!}
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-auto">
                        ...
                        <select class="form-select" id="agency" name="agency">
                                ...
                                @foreach($agency as $ak => $av)
                                    <option value="{{$av->id}}" ?php if(data_get($request,'agency') == $av->id){echo "selected";}?> >
                                        {{ $av->name }}
                                    </option>
                                @endforeach
                        </select>
                    ...
                    <div class="col-auto">
                        <button class="btn btn-primary mr-1 mb-2" title="Carian" type="submit">
            ...
            @else
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-auto">
                        ...
                        <select class="form-select" id="agency" name="agency" disabled="true">
                                <option value=""> Sila Pilih</option>
                                @foreach($agency as $ak => $av)
                                    <option value="{{$av->id}}" ?php if(data_get($userprofile,'userPtj.fk_agency') == $av->id){echo "selected";}?> >
                                        {{ $av->name }}
                                    </option>
                                @endforeach
                        </select>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($ptj as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{ strtoupper(data_get($value, 'name')) }}</td>
                                            ...
                                            <td class="text-center">
                                                <a href="/admin/agency/ptj/edit/{{ data_get($value, 'id') }}"
