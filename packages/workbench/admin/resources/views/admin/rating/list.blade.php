...
<div class="bg-light py-4">
  <div class="container">
      <h5 class="header-style">Lookup Rating</h5>
  </div>
</div>
<div class="container">
        ...
        <div class="card-header">
            ...
            <div class="gap-2">
                <div style="float: left">
                    <h6 class="mt-2 float-left">List Rating</h6>
                </div>
                <div style="float: right">
                    <a href="/admin/rating/add" class="btn btn-primary me-md-2 float-right">Add</a>
                </div>
            </div>
                                        ...
                                        @foreach($rate as $key =>$value)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="/admin/rating/edit/{{$value->id}}" class="btn btn-primary mr-1 mb-2" title="Update">
                                                        <i class="ri-edit-line"></i></a>
                                                    <a href="/admin/rating/delete/{{ $value->id }}" class="btn btn-danger mr-1 mb-2" title="Delete">
