        ...
        <div class="card-header">
            ...
            <div class="gap-2">
                <div style="float: left">
                    <h6 class="mt-2 float-left">Pengurusan Agensi Perkhidmatan</h6>
                </div>
                <div style="float: right">
                    <a href="/admin/agensiptj/khidmat/add/{{ Request::segment(5) }}" class="btn btn-primary me-md-2 float-right">Tambah</a>
                </div>
            </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table id="data-table-khid" class="table mt-2" style="width:100%;font-size: 12px;">
                                ...
                                <tbody>
                                    <?php $bil=1;?>
                                        @foreach($khid as $key =>$value)
                                            <tr>
                                                <td class="text-center">{{ $bil++}}</td>
                                                <td>{{ data_get($value,'nama')}}</td>
                                                <td>{{ data_get($value,'url')}}</td>
                                                ...
                                                <td class="text-center">
                                                    <a href="/admin/agensiptj/khidmat/edit/{{$value->fk_laman_agensi}}/{{$value->id}}" class="btn btn-primary mr-1 mb-2" title="Kemaskini">
