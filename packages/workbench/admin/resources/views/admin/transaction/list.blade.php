...
<div class="bg-light py-4">
  <div class="container">
      <h5 class="header-style">Sejarah Transaksi</h5>
  </div>
</div>
        ...
        <div class="card-header">
            ...
            <div class="gap-2">
                <div style="float: left">
                    <h6 class="mt-2 float-left">Carian Transaksi Bayaran</h6>
                </div>
        ...
        <div class="card-body ">
            ...
            <div class="intro-y box p-5 col-span-12 lg:col-span-12">
                ...
                <div class="grid grid-cols-12 gap-2">
                    <div class="row g-3 align-items-center">
                        <div class="col-4 col-lg-2">
                            <label for="" class="col-form-label" style="float: right;">No Rujukan :</label>
                        </div>
                        <div class="col-4 col-lg-2">
                        ...
                        <div class="col-4 col-lg-2">
                            <label for="" class="col-form-label" style="float: right;">Nama :</label>
                        </div>
                        <div class="col-4 col-lg-2">
                ...
                <br>
                 <div class="grid grid-cols-12 gap-2">
                    <div class="row g-3 align-items-center">
                        <div class="col-4 col-lg-2">
                            <label for="" class="col-form-label" style="float: right;">No Resit :</label>
                        </div>
                        <div class="col-4 col-lg-2">
                        ...
                        <div class="col-4 col-lg-6">
                            <select class="js-example-basic-single3" id="kodhasil" name="" style="width: 100%">
                                ...
                                @foreach($kodhasil as $hk => $hv)
                                    <option value="{{$hv->id}}"> {{ $hv->name }} : {{$hv->lkpperkhidmatan->name}} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#clicksubmit').click(function(e)
        {
            ...
            if(roleid==4 || roleid ==5){
            var val_agency   = "{{data_get($agency,'id')}}";
            var val_ptj   =  "{{data_get($ptj,'id')}}";
