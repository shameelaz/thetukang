...
<div class="bg-light py-4">
  <div class="container">
      <h5 class="header-style">Tambah Manual Video Baru</h5>
  </div>
</div>
<div class="container my-5">
    ...
    <div class="card rounded style-border">
        ...
        {!! form()->open()->post()->action(url('/admin/manual/video/save'))->attribute('id', 'myform')->multipart()->horizontal() !!}
        ...
        <div id="div" style="">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control form-control-sm" placeholder="Jhia786a8d" id="url" name="url" type="text" required>
                </div>
