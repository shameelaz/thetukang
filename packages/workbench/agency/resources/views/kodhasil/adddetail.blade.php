...
<div class="bg-light py-4">
    <div class="container">
        <h5 class="header-style m-0">Tambah Pengurusan Perkhidmatan dan Kod Hasil</h5>
    </div>
</div>
...
<div class="container my-5">
    ...
    <div class="card style-border">
        ...
        {!! form()->open()->post()->action(url('/ptj/kodhasil/savedetail'))->attribute('id', 'myform')->horizontal() !!}

        {{-- {{-- <input type="hidden" name="id" value="{{data_get($kadar,'id')}}"/> --}}
        <input type="hidden" name="fk_service_kod_hasil" value="{{data_get($kdh,'id')}}"/>
