            ...
            <div class="card-header">
                ...
                <div class="gap-2">
                    <div style="float: left">
                        <h6 class="mt-2 float-left">Senarai Perkhidmatan dan Kod Hasil</h6>
                    </div>
                    <div style="float: right">

                        <a href="/ptj/kodhasil/add"
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table id="data-table-kodhasil" class="table mt-2" style="width:100%;font-size: 12px;">
                                        ...
                                        <tbody>
                                            <?php $bil = 1; ?>
                                            @foreach ($kdh as $key => $value)
                                                <tr>
                                                    <td class="text-center">{{ $bil++ }}</td>
                                                    <td>{{ data_get($value, 'lkpperkhidmatan.name') }}</td>
                                                    {{-- <td>{{ data_get($value, 'hasil.name') }}</td> --}}
                                                    <td class="text-center">
                                                        <a href="/ptj/kodhasil/listdetail/{{ $value->id }}"
                                                            class="btn btn-primary mr-1 mb-2" title="Senarai Kod Hasil">
                                                            <i class="ri-list-check"></i></a>
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="/ptj/kodhasil/edit/{{ $value->id }}"
