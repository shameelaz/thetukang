...
@section('content')
    ...
    <div class="bg-light py-4">
        <div class="container">
            <h5 class="header-style">Pengurusan Perkhidmatan Agensi</h5>
        </div>
    </div>
    <br>
    <div class="container">
            ...
            <div class="card-header">
                ...
                <div class="gap-2">
                    <div style="float: left">
                        <h6 class="mt-2 float-left">Senarai Perkhidmatan Agensi</h6>
                    </div>
                    <div style="float: right">

                        <a href="/ptj/servicerate/addMgt"
    ...
    <script type="text/javascript">
        $(document).ready(function()
        {
            ...
            $('#clicksubmit').click(function(e)
            {
                ...
                {
                    type: "get",
                    url : "{{ URL::to('/ptj/servicerate/ajax') }}"+"/"+val_agency+"/"+val_ptj,

                    beforeSend: function ()
                    {

                        $("#render_ajax").html("");
                        $('#data-table-servicerate').DataTable().destroy();
            ...
            $('select[name="fk_agency"]').change(function()
            {
                ...
                if(val)
                {
                    ...
                    {
                        type: "GET",
                        url: "{{ URL::to('/ptj/servicerate/ptj')}}"+"/"+val,
