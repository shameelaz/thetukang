                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($kadar as $key => $value)
                                                <tr>
                                                    ...
                                                    <td class="text-left">{{ data_get($value, 'serviceratemgt.lkpperkhidmatan.name') }}</td>
                                                    <td class="text-left">{{ data_get($value, 'location') }}</td>
                                                    <td class="text-left">{{ data_get($value, 'fkcategory.description') }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="/ptj/servicerate/editkadar/{{ Request::segment(4) }}/{{ $value->id }}"
