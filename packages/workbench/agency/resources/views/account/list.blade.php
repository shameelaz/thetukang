...
@section('content')
    ...
    <div class="bg-light py-4">
        <div class="container">
            <h5 class="header-style">Pengurusan Akaun </h5>
        </div>
    </div>
    <br>
    <div class="container">
            ...
            <div class="card-header">
                ...
                <div class="gap-2">
                    <div style="float: left">
                        <h6 class="mt-2 float-left">Senarai Akaun :  {{ data_get($kodhasil,'name') }}</h6>
                    </div>
                    <div style="float: right">

                        <a href="/ptj/account/add/{{ data_get($kodhasil,'id')  }}" class="btn btn-primary me-md-2 float-right">Tambah</a>
                    ...
                    <div class="row g-2">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table id="data-table-account" class="table mt-2" style="width:100%;font-size: 12px;">
                                    <thead class="table-dark">
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Tarikh Kemaskini</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($account as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ Str::upper(data_get($value, 'identification_no')) }}</td>
                                                <td class="text-center">
                                                    {{ date('d-m-Y', strtotime(data_get($value, 'updated_at'))) }}</td>
                                                ...
                                                @endif
                                                <td class="text-center">
                                                    <a href="/ptj/account/edit/{{ $value->fk_kod_hasil }}/{{ $value->id }}"
                            ...
                            <div>
                                ...
                                <ol style="font-size: 11px !important;">
                                    <li> - Muat turun fail contoh .xlsx (<u><a
                                                href="/uploads/base/lampiran/xlsx/Contoh Maklumat Akaun.xlsx" data-toggle="tooltip"
                                                title="Muat Turun Fail" class="invoice-action-edit mod-edit">Contoh Maklumat Akaun.xlsx</a></u>)</li>
                                    <li> - Masukkan semua data ke dalam fail contoh</li>
                                    <li> - Pastikan ruangan status adalah 1</li>
                                    <li> - Namakan semula fail contoh</li>
                                    <li> - Muat naik fail excel contoh dan klik butang Import</li>
                                </ol>
                                <br>
                                <br>
                                {!! form()->open()->post()->action(route('agency::account.import'))->attribute('id', 'import')->multipart()->horizontal() !!}
                                @csrf
