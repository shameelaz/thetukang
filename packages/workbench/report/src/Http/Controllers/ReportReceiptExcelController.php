...
class ReportReceiptExcelController extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements WithCustomValueBinder,ShouldAutoSize,FromView //,WithDrawings
{
	public function view() : View
	{
		...
		return view('report::report.receipt.excel', compact('data', 'sd', 'ed','now','roleid','userprofile'));
	}
}
