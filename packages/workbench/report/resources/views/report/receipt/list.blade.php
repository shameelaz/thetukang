...
@section('content')
    ...
    <div class="bg-light py-4">
        <div class="container">
            <h5 class="header-style">Laporan Terimaan Harian/ Bulanan</h5>
        </div>
    </div>
    <div class="container">
            ...
            <div class="card-header">
                <div class="gap-2">
                    <div style="float: left">
                        <h6 class="mt-2 float-left">Senarai Terimaan Harian/ Bulanan</h6>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#clicksubmit').click(function(e)
            {
                ...
                {
                    type: "get",
                    url : "{{ URL::to('/report/receipt/ajax') }}"+"/"+val_start+"/"+val_end+"/"+val_agency+"/"+val_ptj,
            ...
            $('select[name="agency"]').change(function()
            {
                ...
                if(val)
                {
                    ...
                    {
                        type: "GET",
                        url: "{{ URL::to('/report/receipt/ptj')}}"+"/"+val,
        ...
        function pdfclick()
        {
            ...
            window.open(
                "/report/receipt/1/"+val_start+"/"+val_end+"/"+val_agency+"/"+val_ptj,
                "-_blank"
            );
        };
        ...
        function excelclick()
        {
            ...
            // window.location.href = "/report/transfer/1/"+val_start+"/"+val_end+"/"+val_type+"/"+val_status;
            window.open(
                "/report/receipt/2/"+val_start+"/"+val_end+"/"+val_agency+"/"+val_ptj,
                "-_blank"
            );
        };
