        ...
        <div id="wizard" class="card wizard style-border">
            ...
            <div class="content clearfix tab-content">
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/login/cart/next'))->attribute('id', 'formpayment')->horizontal() !!}
                ...
                <div class="tab-pane fade" id="summary" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <section>
                         <!-- form()->open()->post()->action(url('/login/cart/next/bayar'))->attribute('id', 'formsummary')->horizontal() !!} -->
                        {!! form()->open()->post()->action(url('/login/bayaran/tiket/bayar'))->attribute('id', 'formsummary')->horizontal() !!}
                        ...
                        <div class="content-wrapper">
                            ...
                            <!-- foreach($list[0]->fk_service as $key => $list) -->
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                      <input type="text" readonly class="form-control-plaintext" id="agency" value="{{ data_get($list, '0.fkservice.fkkodhasil.agency.name') }}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
