        ...
        <div id="wizard" class="card wizard style-border">
            ...
            <div class="content clearfix tab-content">
                <div class="tab-pane fade active" id="pills-search" role="tabpanel" aria-labelledby="pills-home-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/bill/update'))->attribute('id', 'formsubmit')->horizontal() !!}
                        ...
                        {!! form()->open()->post()->action(url('/bayaran/bill/next'))->attribute('id', 'formnext')->horizontal() !!}
                ...
                <div class="tab-pane fade" id="pills-profile-2" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/bill/next'))->attribute('id', 'formpayer')->horizontal() !!}
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="" required style="text-transform: uppercase;">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="identification_no" class="sr-only">No Pengenalan </label>
                                    <input type="text" class="form-control" id="identification_no" name="identification_no" value="" required style="text-transform: uppercase;">
                                </div>
                                <div class="form-group col-md-12">
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/bill/next'))->attribute('id', 'formpayment')->horizontal() !!}
                ...
                <div class="tab-pane fade" id="summary" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/bill/bayar'))->attribute('id', 'formsummary')->horizontal() !!}
                                ...
                                <tbody>
                                    ...
                                    @endforeach
                                        <tr class="table-light">
                                            <td colspan="2" class="text-left"><b>JUMLAH KESELURUHAN (RM)</b></td>
