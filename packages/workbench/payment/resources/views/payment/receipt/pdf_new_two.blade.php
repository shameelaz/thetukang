    ...
    <table style="width:100%; font-size: 10px">
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center; width: 50%;">
                    @if( data_get($data['transaction'], 'flag_original') == 2 )
                        <b>SALINAN</b>
                    @else
                        <b>ASAL</b>
                    @endif
    ...
    <table style="width:100%; font-size: 10px">
        <tbody>
            <tr>
                ...
                <td style="text-align: left; width: 70%; text-transform: uppercase;">
    ...
    <table style="width:100%; font-size: 10px">
        <tbody>
            ...
            <tr>
                ...
                <td style=" text-transform: uppercase; text-align: left; width: 80%;">
