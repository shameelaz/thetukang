        ...
        <div id="wizard" class="card wizard style-border">
            ...
            <div class="content clearfix tab-content">
                <div class="tab-pane fade show active" id="pills-search" role="tabpanel" aria-labelledby="pills-home-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/tiket/update'))->attribute('id', 'formsubmit')->horizontal() !!}
                        ...
                        <div class="content-wrapper">
                            <h4 class="section-heading">Senarai Tiket {{ data_get($kodhasil, 'lkpperkhidmatan.name') }}</h4>
                        ...
                        {!! form()->open()->post()->action(url('/bayaran/tiket/next'))->attribute('id', 'formnext')->horizontal() !!}
                ...
                <div class="tab-pane fade" id="pills-profile-2" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/tiket/next'))->attribute('id', 'formpayer')->horizontal() !!}
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="identification_no" name="identification_no" value="" required >
                                </div>
                                <div class="form-group col-md-12">
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/tiket/next'))->attribute('id', 'formpayment')->horizontal() !!}
                ...
                <div class="tab-pane fade" id="summary" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/tiket/bayar'))->attribute('id', 'formsummary')->horizontal() !!}
                        ...
                        <input type="hidden"  name="flagpay" value="1"/>
                        ...
                        <div class="content-wrapper">
                            ...
                            <h4 class="section-heading">Maklumat Tiket : {{ data_get($kodhasil,'lkpperkhidmatan.name') }}</h4>
                            <div class="mb-3 row">
                                <label for="tarikhlawatan" class="col-sm-2 col-form-label">Tarikh Lawatan</label>
                                <div class="col-sm-10">
                                  <input type="text" readonly class="form-control-plaintext" id="tarikhlawatan" value="{{ date('d-m-Y',strtotime(data_get($srvmain,'tarikh_lawatan'))) }}">
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    {!! form()->open()->post()->action(url('/bayaran/tiket/'.data_get($srvmain,"fk_kod_hasil").'/'.$tab.'/edit/'.$srvratemgt->id.'/delete'))->horizontal() !!}
