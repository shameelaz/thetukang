        ...
        <div id="wizard" class="card wizard style-border">
            ...
            <div class="content clearfix tab-content">
                <div class="tab-pane fade show active" id="pills-search" role="tabpanel" aria-labelledby="pills-home-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/hasil/update'))->attribute('id', 'formsubmit')->horizontal() !!}
                        ...
                        {!! form()->open()->post()->action(url('/bayaran/hasil/next'))->attribute('id', 'formnext')->horizontal() !!}
                ...
                <div class="tab-pane fade" id="pills-profile-2" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/hasil/next'))->attribute('id', 'formpayer')->horizontal() !!}
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/hasil/next'))->attribute('id', 'formpayment')->horizontal() !!}
                ...
                <div class="tab-pane fade" id="summary" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/bayaran/hasil/bayar'))->attribute('id', 'formsummary')->horizontal() !!}
                        ...
                        <input type="hidden"  name="flagpay" value="3"/><!--others-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    {!! form()->open()->post()->action(url('/bayaran/hasil/'.data_get($srvmain,"fk_kod_hasil").'/'.$tab.'/edit/'.$srvratemgt->id.'/delete'))->horizontal() !!}
                    ...
                    <div class="px-5 pb-8 text-center">
                        ...
                        <button type="button" data-bs-dismiss="modal" class="btn btn-outline-secondary w-24 dark:border-dark-5 dark:text-gray-300 mr-1">Batal</button>

                        <input type="submit" class="btn btn-danger w-30" value="Ya. padamkannya!">
