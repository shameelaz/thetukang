        ...
        <div id="wizard" class="card wizard style-border">
            ...
            <div class="content clearfix tab-content">
                <div class="tab-pane fade show active" id="pills-search" role="tabpanel" aria-labelledby="pills-home-tab">
                    <section>
                        {!! form()->open()->post()->action(url('/login/bayaran/multi/save'))->attribute('id', 'formsubmit')->horizontal() !!}
                        <input type="hidden" name="perkhidmatan_type" value="{{ data_get($lkpperkhidmatan, 'type') }}" />
                        <input type="hidden" name="perkhidmatan" value="{{ data_get($lkpperkhidmatan, 'id') }}" />
                        <input type="hidden"  name="flaglogin" value="1"/>
    ...
    <script type="text/javascript">
        $( document ).ready(function() 
        {
            ...
            $('#btn-cari').click(function()
            {
                ...
                $.ajax(
                {
                    url: "{{ URL::to('login/bayaran/multi/search/') }}" + "/" + serviceid + "/" + refno + "/" + refid,
                    type: "get",
